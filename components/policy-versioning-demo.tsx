...
export const PolicyVersioningDemo: React.FC = () => {
  ...
  const policyData = policies[0] // Use first policy for demo
  ...
  const lastAcceptedVersion = policyData.userAcceptances
    .filter((a) => a.userId === currentUser.id && a.isValid)
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <Card className="flex flex-col">
            <CardHeader className="flex-shrink-0">
              ...
              <CardDescription>Policy acceptance history and status</CardDescription>
            </CardHeader>
